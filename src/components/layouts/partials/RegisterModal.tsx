        ...
        <>
            <div className='fixed w-full h-full flex justify-center items-center top-0 right-0 z-100 bg-black/50 backdrop-blur-sm'>
                <Card title='Register As' className='w-[90%] md:w-2xl mx-auto relative' titleClassName='text-lg'>
                    <button aria-label="Close modal" onClick={() => toggleRegisterModal()} className="absolute top-2 right-2 bg-transparent border-none p-0">
                        <FontAwesomeIcon icon={faTimes} className='text-xl cursor-pointer transition-all hover:text-[var(--primary-color)] scale-100 hover:scale-120' />
                    </button>
