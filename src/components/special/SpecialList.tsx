...
import BidProduct from "../product/BidProduct";
import HireProduct from "../product/HireProduct";
...
export default function ProductList({
    ...
    const [filters, setFilters] = useState<FilterState>({
        ...
        scope: 2, // Assuming 2 is the ID for "Special" scope
