    ...
    return (
        <div className="quntity-input-box relative mb-3 flex">
            <input
                ...
                value={value}
            />
            <button className="bg-secondary absolute left-0 h-[35px] w-[35px] text-white flex items-center justify-center"
                onClick={() => onChange(Math.max(0, value - 1))}>
                <FontAwesomeIcon icon={faMinus} className="w-5 h-5" />
            </button>
            <button className="bg-secondary absolute right-0 h-[35px] w-[35px] text-white flex items-center justify-center"
